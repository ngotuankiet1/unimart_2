...
<head>
    ...
    <script src="https://cdn.tiny.cloud/1/7jbjxwqeo8ip0st411v8pk5gsyl17oh3meih98awfxy5znuv/tinymce/4/tinymce.min.js" referrerpolicy="origin"></script>

    <script>
        var editor_config = {
          path_absolute : "http://localhost:8080/unitop.vn/Laravel/unimark/",
          selector: "textarea",
          plugins: [
...
<body>
    ...
    <div id="warpper" class="nav-fixed">
        <nav class="topnav shadow navbar-light bg-white d-flex">
            <div class="navbar-brand"><a href="?">UNIMART</a></div>
            <div class="nav-right ">
                <div class="btn-group mr-auto">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="{{url('')}}">Thêm đơn hàng</a>
                    </div>
                </div>
                <div class="btn-group">
